...
// Serves as a reference to look up the materialUiTheme theme properties being used
export const materialUiThemeReference = {
  breakpoints: {
    keys: ['xs', 'sm', 'md', 'lg', 'xl'],
...
// https://material.io/tools/color/#!/?view.left=0&view.right=0&secondary.color=D81B60&primary.color=212121
